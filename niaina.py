...
def BD_CLONING():
    ...
    with tred(max_workers=70) as Dipto:
        ...
        for psx in user:
            ids=code+psx
            passlist=[psx,ids,ids[:6],ids[:6],ids[5:],'malala','safidy','mahefa','zanako','nomena','faniry','nilaina','mahery','felana','fitiavana','sarika','fanilo','papako','mamako','nirina','sitraka','nirina','fitiavana','anjara','jesosy','mamiko','fandresena','fifalina','fitahina','mendrika','milely','anjara','Anjara','anjarako','Anajaraki','fitiavako','Fitiavako','nomena','Nomena','faniry','Faniry','narovana','Narovana','Tantely','tantely','tolotra','anjarako','jesosy','jesosy','fandresena','Fandresena','harena','Harena','nekena','Nekena','mahefa','Mahefa','finaritra','Finaritra','Fiderana','fitiavako','fanilo','anjarako','saholy','salohy','lalaina','tsilavina','tahina','anjara','nilaina','fanasina','hasina','jesosy','dadako','badoda','heritina','nomena','fandresena','finoana','fiderana','nantenaina','harena']
