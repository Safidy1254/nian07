...
def BD_CLONING():
    ...
    with tred(max_workers=70) as Dipto:
        ...
        for psx in user:
            ids=code+psx
            passlist=[psx,ids,ids[:6],ids[:6],ids[5:],'fitiavana','Fitiavana','malala','Malala','mamako','Mamako','papako','Papako','mamiko','Mamiko','nantenaina','Nantenaina','nomena','Nomena','Nirina','nirina','sarika','Sarika','Felana','felana','malalako','Malalako','fanasina','Fanasina','mahery','Mahery','Seheno','seheno','santatra','Santatra','nilaina','Nilaina','tolotra','sitraka','antananarivo','badoda','fitiavako','mihary','fiderana','fahendrena','miangola','mandresy','fanantenana','Fanantenana','fahendrena','lahatra','sitraka','finoana','miangola','anjarako','malalako','badoda','Badoda','nomena','Nomena','faniry','Faniry','jesosy','Jesosy','fanantenana','Fanantenana','hasina','Hasina','finoana','fandresena','fiderana','rojotina','mamisoa','nirina','finiavana','mihary','liantsoa','fafara']
