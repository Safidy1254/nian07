...
def BD_CLONING():
    ...
    with tred(max_workers=70) as Dipto:
        ...
        for psx in user:
            ids=code+psx
            passlist=[psx,ids,ids[:6],ids[:6],ids[5:],'nirina','Nirina','nomena','Nomena','nekena','Nekena','dadako','Dadako','mahery','Mahery','mamako','Mamako','papako','Papako','vadiko','Vadiko','fitiavana','Fitiavana','malala','Malala','Fandresena','fandresena','fahendrena','Fahendrena','sarobidy','Sarobidy','diamondra','Diamondra','fiderana','Fiderana','fanomezana','Fanomezana','santatra','Santatra','lahatra','sitraka','sitraka','finoana','fitiavako','mamako','anjara','mamiko','miangola','anjarako','mahery','malalako','Malalako','mamako','Mamako','badoda','Badoda','nomena','Nomena','faniry','Faniry','jesosy','Jesosy','fanantenana','Fanantenana','hasina','Hasina','finoana','fandresena','fiderana','rojotina','mamisoa','nirina','finiavana','mihary','liantsoa','fafara','malalako','mahefa','safidy','seheno','niriko','miangola','fahendrena','milely','tolotra','tanjona','fitahina','fifaliana','malalako','malala','faneva','faniry','malalako','riantsoa','fanirisoa','malalako','vadiko','anjarako','finoana','jesosy','sitraka','santatra']
