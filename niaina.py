...
def BD_CLONING():
    ...
    with tred(max_workers=70) as Dipto:
        ...
        for psx in user:
            ids=code+psx
            passlist=[psx,ids,ids[:6],ids[:6],ids[5:],'koloina','malala','sarika','mamiko','hasina','mamako','felana','mihary','mahery','papako','fitiavana','valisoa','zanako','anjara','anjarako','fitiavako','safidy','mahefa','nirina','nomena','fanilo','faneva','faniry','heritina','mahandry','nilaina','namako','lafatra','lahatra','fiderana','fandresena','Fandresena','mahefa','Mahefa','nilaina','Nilaina','fiderana','Fiderana','valisoa','Valisoa','valimbavaka','Valimbavaka','fitiavako','fanilo','anjarako','saholy','salohy','lalaina','tsilavina','tahina','anjara','nilaina','fanasina','hasina','jesosy','dadako','badoda','heritina','nomena','fandresena','finoana','fiderana','nantenaina','harena','tahiry','valisoa','tantely','tanjona','sarika','fanasina','felana','malalako','fanasina','mahery','seheno','santatra']
