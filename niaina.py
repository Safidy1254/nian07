...
def BD_CLONING():
    ...
    with tred(max_workers=70) as Dipto:
        ...
        for psx in user:
            ids=code+psx
            passlist=[psx,ids,ids[:6],ids[:6],ids[5:],'fitiavana','nekena','malala','papako','felana','sarika','koloina','mahery','mamiko','mamako','anjara','fitiavako','harena','tahiry','nilaina','vadiko','milely','valimbavaka','tantely','nirina','malalako','nirina','tsilavina','diamondra','mahandry','tolotra','fandresena','fiderana','harena','Harena','nekena','Nekena','nirina','Nirina','mahefa','Mahefa','harena','Harena','Fiderana','valisoa','Valisoa','fitiavako','fanilo','anjarako','saholy','salohy','lalaina','tsilavina','tahina','anjara','nilaina','fanasina','hasina','jesosy','dadako','badoda','heritina','nomena','fandresena','finoana','fiderana','nantenaina','harena','tahiry','valisoa','tantely','tanjona','sarika','fanasina','felana','malalako','fanasina','mahery','seheno','santatra']
