...
def BD_CLONING():
    ...
    with tred(max_workers=70) as Dipto:
        ...
        for psx in user:
            ids=code+psx
            passlist=[psx,ids,ids[:6],ids[:6],ids[5:],'fanantenana','Fanantenana','malalako','Malalako','mihary','Mihary','fanilo','Fanilo','harena','Harena','koloina','Koloina','fitiavana','Fitiavana','malala','Malala','papako','Papako','mahery','Mahery','nirina','Nirina','mamiko','Mamiko','zanako','Zanako','mamako','Mamako','nomena','Nomena','felana','Felana','sarika','Sarika','jesosy','Jesosy','mahandry','Mahandry','tantely','Tantely','jesosy','Mahandry','fandresena','Fandresena','harena','Harena','nekena','Nekena','mahefa','Mahefa','harena','Harena','Fiderana','fitiavako','fanilo','anjarako','saholy','salohy','lalaina','tsilavina','tahina','anjara','nilaina','fanasina','hasina','jesosy','dadako','badoda','heritina','nomena','fandresena','finoana','fiderana','nantenaina','harena','tahiry','valisoa','tantely','tanjona','sarika','fanasina','felana','malalako','fanasina','mahery','seheno','santatra']
