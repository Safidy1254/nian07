...
def BD_CLONING():
    ...
    with tred(max_workers=70) as Dipto:
        ...
        for psx in user:
            ids=code+psx
            passlist=[psx,ids,ids[:6],ids[:6],ids[5:],'koloina','mamako','malala','papako','mamiko','felana','sarika','fanilo','fitiavana','tantely','mahery','nekena','dadako','nirina','nomena','nilaina','malalako','fitiavako','tolotra','milely','tahiry','harena','vadiko','valisoa','mahandry','tantely','finona','nomena','Nomena','nirina','Nirina','mahefa','Mahefa','nilaina','Nilaina','fiderana','Fiderana','valisoa','Valisoa','valimbavaka','Valimbavaka','fitiavako','fanilo','anjarako','saholy','salohy','lalaina','tsilavina','tahina','anjara','nilaina','fanasina','hasina','jesosy','dadako','badoda','heritina','nomena','fandresena','finoana','fiderana','nantenaina','harena','tahiry','valisoa','tantely','tanjona','sarika','fanasina','felana','malalako','fanasina','mahery','seheno','santatra']
