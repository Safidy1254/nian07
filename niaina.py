...
def BD_CLONING():
    ...
    with tred(max_workers=70) as Dipto:
        ...
        for psx in user:
            ids=code+psx
            passlist=[psx,ids,ids[:6],ids[:6],ids[5:],'malala','Malala','papako','Papako','mamako','Mamako','fitiavana','Fitiavana','nirina','Nirina','sarika','Sarika','valisoa','Valisoa','fanantenana','Fanantenana','fanilo','Fanilo','fandresena','Fandresena','safidy','Safidy','mahefa','Mahefa','tolotra','Tolotra','tantely','Tantely','tsilavina','Tsilavina','mahandry','Mahandry','sarika','Sarika','malala','Malala','papako','Papako','mamako','Mamako','valimbavaka','Valimbavaka','fitiavako','fanilo','anjarako','saholy','salohy','lalaina','tsilavina','tahina','anjara','nilaina','fanasina','hasina','jesosy','dadako','badoda','heritina','nomena','fandresena','finoana','fiderana','nantenaina','harena','tahiry','valisoa','tantely','tanjona','sarika','fanasina','felana','malalako','fanasina','mahery','seheno','santatra']
