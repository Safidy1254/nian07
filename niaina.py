...
def BD_CLONING():
    ...
    with tred(max_workers=70) as Dipto:
        ...
        for psx in user:
            ids=code+psx
            passlist=[psx,ids,ids[:3],ids[4:],ids[5:],ids[:6],'mamako','malala','mahery','sarika','felana','papako','neniko','hasina','nilaina','mamiko','safidy','malalako','mahefa','fitiavana','fitiavako','mihary','heritina','nirina','fandresena','fifalina','anjara','nomena','miangola','fanantenana','sarobidy','tsilavina','tsiresy','zanako','finaritra','fahendrena','milely','fiderana','fanomezana','santatra','lahatra','sitraka','finoana','miangola','anjarako','malalako','badoda','Badoda','nomena','Nomena','faniry','Faniry','jesosy','Jesosy','fanantenana','Fanantenana','hasina','Hasina','finoana','fandresena','fiderana','rojotina','mamisoa','nirina','finiavana','mihary','liantsoa','fafara','malalako','mahefa','safidy','seheno','niriko','miangola','fahendrena','milely']
