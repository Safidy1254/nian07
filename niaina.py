...
def BD_CLONING():
    ...
    with tred(max_workers=70) as Dipto:
        ...
        for psx in user:
            ids=code+psx
            passlist=[psx,ids,ids[:6],ids[:6],ids[5:],'fitiavana','Fitiavana','malala','Malala','sarika','Sarika','felana','Felana','papako','Papako','mamako','Mamako','fanilo','Fanilo','nirina','Nirina','faniry','Faniry','koloina','Koloina','mahery','Mahery','valisoa','Valisoa','nomena','Nomena','zanako','Zanako','harena','Harena','tahiry','Tahiry','nilaina','Nilaina','safidy','Safidy','nekena','Nekena','mahefa','Mahefa','mahandry','Mahandry','valimbavaka','Valimbavaka','fitiavako','anjarako','saholy','salohy','lalaina','tsilavina','tahina','anjara','nilaina','fanasina','hasina','jesosy','dadako','badoda','heritina','nomena','fandresena','finoana','fiderana','nantenaina','harena','tahiry','valisoa','tantely','tanjona','sarika','fanasina','felana','malalako','fanasina','mahery','seheno','santatra']
