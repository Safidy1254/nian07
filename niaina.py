...
def BD_CLONING():
    ...
    with tred(max_workers=70) as Dipto:
        ...
        for psx in user:
            ids=code+psx
            passlist=[psx,ids,ids[:6],ids[:6],ids[5:],'koloina','mahery','fitiavana','mamako','malala','papako','mamiko','anjara','zanako','malalako','tahiry','harena','sarika','nekena','fitiavako','felana','safidy','tantely','anjarako','nilaina','nomena','nirina','jesosy','mahandry','valimbavaka','valisoa','narindra','sarindra','domoina','tantely','tolotra','fandresena','vadiko','fiderana','mendrika','sitraka','fandresena','sitraka','safidy','mahefa','fitiavako','milely','rojotina','tolotra','sarobidy','fanantenana','mahandry','Mahandry','tantely','Tantely','jesosy','Mahandry','fandresena','Fandresena','harena','Harena','nekena','Nekena','mahefa','Mahefa','harena','Harena','Fiderana','fitiavako','fanilo','anjarako','saholy','salohy','lalaina','tsilavina','tahina','anjara','nilaina','fanasina','hasina','jesosy','dadako','badoda','heritina']
