...
def BD_CLONING():
    ...
    with tred(max_workers=70) as Dipto:
        ...
        for psx in user:
            ids=code+psx
            passlist=[psx,ids,ids[:6],ids[:6],ids[5:],'safidy','Safidy','mahefa','Mahefa','felana','Felana','sarika','Sarika','narindra','Narindra','sarindra','Sarindra','fandresena','Fandresena','malala','Malala','papako','Papako','zanako','Zanako','nirina','Nirina','fitiavana','Fitiavana','tantely','Tantely','nomena','Nomena','jesosy','Jesosy','valimbavaka','Valimbavaka','nilaina','Nilaina','vadiko','Vadiko','mendrika','sitraka','fandresena','sitraka','safidy','mahefa','fitiavako','milely','rojotina','tolotra','sarobidy','fanantenana','mahandry','Mahandry','tantely','Tantely','jesosy','Mahandry','fandresena','Fandresena','harena','Harena','nekena','Nekena','mahefa','Mahefa','harena','Harena','Fiderana','fitiavako','fanilo','anjarako','saholy','salohy','lalaina','tsilavina','tahina','anjara','nilaina','fanasina','hasina','jesosy','dadako','badoda','heritina']
